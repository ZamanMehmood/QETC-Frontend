...
export function CreateUniversity() {
  ...
  //   }
  //   if (values.type === "") {
  //     errors.type = "please enter your type  ";
  //   }
  //   if (values.counserllerName === "") {
  //     errors.counserllerName = "please enter your counserllerName  ";
  //   }
  //   if (values.phone === "") {
  ...
  //   }
  //   if (values.visaAppFee === "") {
  //     errors.visaAppFee = "please enter your visaAppFee  ";
  //   }
  //   if (values.addmissionFee === "") {
  //     errors.addmissionFee = "please enter your addmissionFee  ";
  //   }
  //   if (values.qetcFee === "") {
  //     errors.qetcFee = "please enter your qetcFee  ";
  //   }
  //   if (values.commisionDuration === "") {
  //     errors.commisionDuration = "please enter your commisionDuration  ";
  //   }
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              {isViewMode ? (
                ...
                <FileUploader
                  ...
                  // required
                  required="true"
                  requiredMessage="You must select the ZIP file to upload"
                  // types={fileTypes}
                >
          ...
          <div className="mt-12 mb-6 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <input
                ...
                required
              />
              {/* <p className="text-red-500">{formErrors.counserllerName}</p> */}
            </div>
            <div>
              <label className="mb-2 block text-sm font-semibold text-[#333333]">
                Phone Number
          ...
          <div className="my-[30px] mr-8 rounded-[34px] bg-white p-[39px]">
            ...
            <div className="mt-12 mb-6 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <div>
                ...
                {/* <p className="text-red-500">{formErrors.visaAppFee}</p> */}
              </div>
              <div>
                <label className="mb-2 block text-sm font-semibold text-[#333333]">
                  Admission Fee
                ...
                {/* <p className="text-red-500">{formErrors.addmissionFee}</p> */}
              </div>
              <div>
                <label className="mb-2 block text-sm font-semibold text-[#333333]">
                ...
                {/* <p className="text-red-500">{formErrors.qetcFee}</p> */}
              </div>
              <div>
                <label className="mb-2 block text-sm font-semibold text-[#333333]">
                  Commission Duration
                ...
                {/* <p className="text-red-500">{formErrors.commisionDuration}</p> */}
              </div>
              <div>
                <label className="mb-2 block text-sm font-semibold text-[#333333]">
                  Add More Field
                ...
                <button
                  type="button"
                  class="w-full rounded-xl border-2 border-[#CBD2DC80] bg-[#F8F9FB] p-2.5 font-medium text-[#BEBFC3]"
                >
                  Click to add more field
                </button>
              </div>
