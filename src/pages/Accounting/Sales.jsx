...
export function Sales() {
  ...
  return (
    <>
      <div
        className={`mt-[30px] flex w-full font-display flex-col gap-8 bg-[#E8E9EB] ${
          salesState ? "" : "hidden"
        }`}
      >
        <div>
        <div className=" rounded-[34px] bg-white p-6 md:p-12">
          <div className="my-0 flex w-full flex-col sm:flex-row sm:items-center justify-between gap-3 pt-0 pb-5">
            <p className="text-2xl sm:text-3xl font-bold text-black">Sales recording</p>
              <Button onClick={() => setSalesState(false)} className="flex h-[60px] ml-auto p-2 sm:py-3 sm:px-6 flex-row items-center rounded-2xl bg-[#280559]">
          ...
          <div className="flex flex-col overflow-x-auto">
            <table className=" w-full border-none">
              ...
              <tbody className="border-none">
                {Sales_recording_data.map(({date, name, description, salesAmount, salesAmountColor}) => (
                  <tr key={name}>
                  ...
                  <td className="whitespace-nowrap px-6 py-4 text-lg font-medium text-[#333]">
                    <span style={{color: salesAmountColor}}>{salesAmount}</span>
                  </td>
                  <td>
                      <Button
                        variant="outlined"
      ...
      >
      <div className="my-5">
        <p className=" text-4xl font-semibold text-[#280559] mb-2">Create Sales</p>
    ...
    <div className="grid gap-6 mt-4 mb-6 md:grid-cols-2 lg:grid-cols-3">
        <div>
            <label className="block mb-2 text-sm font-semibold text-[#333333]">Name of Sale</label>
            <input type="text" className="placeholder:text-[#BEBFC3] rounded-xl bg-white border-2 border-[#CBD2DC80] p-2.5 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block w-full" placeholder="Sale Name" required/>
        </div>
        <div>
    ...
    <input type="text" className="pl-16 placeholder:text-[#BEBFC3] h-full rounded-xl bg-white border-2 border-[#CBD2DC80] p-2.5 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block w-full" placeholder="0.00" required/>
      ...
      <NavLink>
        <Button onClick={() => setSalesState(true)} className="rounded-[15px]  bg-[#280559]">
