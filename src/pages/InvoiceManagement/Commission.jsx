      ...
      <div>
        <div className=" rounded-[34px] bg-white p-6 md:p-12">
          <div className="my-0 flex w-full flex-col sm:flex-row sm:items-center justify-between gap-3 pt-0 pb-5">
            <p className="text-2xl sm:text-3xl font-bold text-black">Commission Invoice</p>
          ...
          <div className="my-3 flex flex-col lg:flex-row justify-center items-center gap-3 rounded-[20px] bg-[#F8F9FB] p-5">
