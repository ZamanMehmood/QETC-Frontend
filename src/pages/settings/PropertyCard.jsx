...
export function PropertyCard({ title, type = 0 }) {
  ...
  console.log("propertiess data in properties module 0==>", propertiesData);

  useEffect(() => {
    dispatch(listProperties());
    // if (propertiesData?.success == true) {
    //   let { message } = propertiesData;
        ...
        <div className="my-0 flex w-full flex-col justify-between gap-3 pt-0 pb-5 sm:flex-row sm:items-center">
          ...
          >
            ...
            <Link
              ...
              to={`/dashboard/settingsManagement/property/3/${type}`}
            >
              Add New Status
            </Link>
          </Button>
            ...
            <div className="flex flex-col overflow-x-auto">
              <table className="w-full border-none">
                ...
                <tbody className="border-none">
                  {propertiesData?.data?.faqs?.map((ele, ind) => (
                    <tr key={ind}>
                      <td
                      ...
                      <td>
                        <Button
                          ...
                          onClick={() =>
                            navigate(
                              `/dashboard/settingsManagement/properties/1/${ele?.id}`
                            )
                          }
                        >
